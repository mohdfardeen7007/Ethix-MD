...
if (time2 < "05:00:00") {
  pushwish = `𝐆ⱺⱺᑯ 𝐌ⱺ𝗋𐓣𝗂𐓣𝗀 🌄`;
} else if (time2 < "11:00:00") {
  pushwish = `𝐆ⱺⱺᑯ 𝐌ⱺ𝗋𐓣𝗂𐓣𝗀 🌄`;
} else if (time2 < "15:00:00") {
  pushwish = `𝐆ⱺⱺᑯ 𝐀𝖿𝗍𝖾𝗋𐓣ⱺⱺ𐓣 🌅`;
} else if (time2 < "18:00:00") {
  pushwish = `𝐆ⱺⱺᑯ 𝐄𝗏𝖾𐓣𝗂𐓣𝗀 🌃`;
...
│ㅤ࣪ㅤ🧺ᩙㅤׅ𝐌ⱺᑯ𝖾: *${mode}*
│ㅤ࣪ㅤ🧺ᩙㅤׅ𝐏𝗋𝖾𝖿𝗂𝗑: *[Multi-Prefix]*
╰─────────────━┈⊷ `
            }),
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "˗ˋˏ 𝚰 𝖽o𝗇'𝗍 𝖿𝛐𝗋g𝗂𝛎𝖾 𝖻𝐞𝖼𝛂𝗎𝗌𝖾 
          𝚻𝗁𝖾 𝗉𝛂𝗌𝗍 𝛈𝖾𝗏𝖾𝗋 𝖽𝐢𝖾𝗌"
            }),
            ...
            nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
              buttons: [
                {
                  "name": "single_select",
                  "buttonParamsJson": `{"title":"ㅤ࣪ㅤ🧺ᩙㅤׅㅤ࣪𝚻𝚫𝚸 𝐅𝚯𝚪 𝚯𝚸𝚵𝚴 𝚳𝚵𝚴𝐔",
                 "sections":
                   [{
                    "title":"𝐅𝖾ᥣ𝗂𝗑 𝐀ᥣᥣ 𝐌𝖾𐓣υ",
                    "highlight_label":"🤩 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "rows":[
                      {
                       "header":"",
                       "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"🎨𝐅𝖾ᥣ𝗂𝗑 𝐀ᥣᥣ 𝐌𝖾𐓣υ🎨",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
